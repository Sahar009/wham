...
useEffect(() =>{
 ...
 const calculateTotalPrice = () => {
   ...
   // Filter students with balance above zero
   const studentsWithPositiveBalance = currentItems.filter(
    (student) => student.price - student.paid > 0
  );
      ...
      <div className="table">
        {isLoading && students.length === 0 ? (
          ...
          <table>
              ...
              <tbody>
              {studentsWithPositiveBalance.map((student, index) => {
